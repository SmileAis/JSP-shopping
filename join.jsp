...
<body>
	...
	<div class="container" style="box-shadow: 5px 5px 10px 6px gray; margin-top:30px;">
		<form name="newMember" class="form-horizontal add_m"  action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
		<br>
		<h1 class="display-3" style="text-align:center; text-shadow: 2px 2px 10px 2px black;">회원 가입</h1>
		<br>
		<hr>
		<br>
